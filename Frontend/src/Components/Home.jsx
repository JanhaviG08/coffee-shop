                ...
                <div className="grid grid-cols-1 sm:grid-cols-2">
                    ...
                    <div className="order-2 sm:order-1 flex flex-col justify-center gap-6">
                       <h1 data-aos="fade-up" data-aos-once="true" className="text-5xl sm:text-6xl lg:text-7xl font-bold">
                          ...
                          <span data-aos="zoom-out" data-aos-delay="300" className="text-primary font-cursive"> Coffee </span> 
                          in the city {" "}
                        </h1>
                        <div data-aos="fade-up" data-aos-delay="400">
                            <button className="bg-gradient-to-r from-primary to-secondary border-2 border-primary rounded-full py-4 px-2 text-white hover:scale-105 duration-200">
                                Coffee and Code
                            </button>
                        </div>
                    </div>
                    ...
                    <div data-aos="zoom-in" className="min-h-[450px] flex justify-center items-center order-1 sm:order-2 relative">
                        <img src={HeroImg}  className="w-[-300px] sm:w-[400px] sm:scale-110 mx-auto spin"/>
